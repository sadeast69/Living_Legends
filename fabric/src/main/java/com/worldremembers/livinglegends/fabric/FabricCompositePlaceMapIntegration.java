...
final class FabricCompositePlaceMapIntegration implements PlaceMapIntegration {
    private final List<PlaceMapIntegration> integrations;

    FabricCompositePlaceMapIntegration(Collection<PlaceMapIntegration> integrations) {
